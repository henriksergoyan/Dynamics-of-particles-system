...
//  PlotFrame temperatureData = new PlotFrame("time", "temperature", "Mean temperature");
  ...
  public void initialize() {
    ...
    md.c = control.getDouble("c");
    md.M = control.getDouble("M");
    md.g = control.getDouble("g");
    md.f = control.getDouble("f");
    
    md.initialize();
    display.addDrawable(md);
    display.setPreferredMinMax(-5, md.Lx + 5, -5, md.Ly+5); // assumes vmax = 2*initalTemp and bin width = Vmax/N
...
//    temperatureData.append(0, md.t, md.getMeanTemperature());
   ...
   */
  public void reset() {
    control.setValue("nx", 3);
    control.setValue("ny", 3);
    ...
    control.setAdjustableValue("c", 1);
    control.setAdjustableValue("M", 1);
    control.setAdjustableValue("f", 1);
    control.setAdjustableValue("g", 1);
